...
import nekoqol.NekoQOL.Companion.configData
import nekoqol.config.ConfigManager.parseData
import nekoqol.config.ConfigManager.writeConfig
import nekoqol.features.NoBlockAnimation.Companion.blacklist
...
class BlockAnimationBlacklist : WindowScreen(newGuiScale = GuiScale.scaleForScreenSize().ordinal) {
    ...
    override fun onScreenClose() {
        ...
        parseData()
        NekoQOL.configFile?.let { writeConfig(it) }
    }
}
